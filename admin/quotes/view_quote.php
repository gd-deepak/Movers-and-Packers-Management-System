    ...
    <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
        <div class="card card-outline card-primary rounded-0 shadow">
            <div class="card-body">
                <div class="container-fluid" id="printout">
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <label for="" class="control-label text-muted">Origin</label>
                                <div class="pl-4"><?= isset($origin) ? (str_replace(["\n\r", "\n", "\r"], '<br>', htmlspecialchars_decode($origin))) : '' ?></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <label for="" class="control-label text-muted">Destination</label>
                                <div class="pl-4"><?= isset($destination) ? (str_replace(["\n\r", "\n", "\r"], '<br>', htmlspecialchars_decode($destination))) : '' ?></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card-footer py-1 text-center">
                ...
                <button id="manage_remarks" class="btn btn-primary btn-flat bg-gradient-primary btn-sm" type="button"><i class="fa fa-pen"></i> Manage Remarks</button>
