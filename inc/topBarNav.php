            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link text-white" href="./?p=request_quote">Request</a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="./?p=about">About</a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="">Track order</a></li> 
                        <li class="nav-item"><a class="nav-link text-white" href="./?p=contact">Contact Us</a></li>
                     
                    </ul>
                    <div class="d-flex align-items-center">
                    <!-- <a class="font-weight-bolder text-light mx-2 text-decoration-none"> $_SESSION['username'] </a> -->
                        <a class="font-weight-bolder text-light mx-2 text-decoration-none" href="./admin">Admin Panel</a>
                        <a  class="font-weight-bolder text-light mx-2 text-decoration-none" href="./signup/logout.php">Logout</a>
